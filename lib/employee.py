...
class Employee:
    ...
    def instance_from_db(cls, row):
        ...
        if employee:
            # Update attributes if already cached
            employee.name = row[1]
    ...
    def reviews(self):
        """Return list of Review instances associated with the current employee."""
        from lib.review import Review  # Import here to avoid circular imports
